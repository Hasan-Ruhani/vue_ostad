            ...
            <div className="header">
                ...
                <div className="header-left">
                    <a href="index.html" className="logo">
                        <img src={"https://html.themexriver.com/Orixy/assets/img/logo/logo5.png"} alt="Logo"/>
                    </a>
                    <a href="index.html" className="logo logo-small">
                        <img src={"https://html.themexriver.com/Orixy/assets/img/logo/logo5.png"} alt="Logo" width="30" height="30"/>
                    </a>
                </div>
                        ...
                        {isOpen && <div className="dropdown-menu d-block sjgdhsgdf">
                            <div className="admin-header">
                                ...
                                <div className="admin-text">
                                    <h6>{profile?.user?.name ? profile?.user?.name : "Anounmus"}</h6>
                                    <p className="text-muted mb-0">{profile?.user?.role ? "Admin" : "None"}</p>
                                </div>
                            </div>
