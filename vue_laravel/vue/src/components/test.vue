...
<template>
    <div>
      ...
      <button @click="openModal" class="bg-blue-500 text-white p-2 rounded">
        Open Modal
      </button>
          ...
          >
            ...
            <div class="mt-4 mb-6">
              ...
              <p class="text-sm text-gray-700 dark:text-gray-400">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum ac velit sit amet neque porttitor lacinia.
              </p>
            </div>
