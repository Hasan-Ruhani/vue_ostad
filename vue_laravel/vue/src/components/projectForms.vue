          ...
          <label class="block text-sm w-full">
            ...
            <div class="relative text-gray-500 focus-within:text-purple-600">
              <select
                ...
                class="block appearance-none w-full pr-20 mt-1 text-sm text-black border-gray-600 bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple text-gray-300 form-select rounded-l-md rounded-[5px]"
