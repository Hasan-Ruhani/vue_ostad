...
function toggleProducts(orderId){
    const order_item = order.orders.find(order => order.id === orderId);
    if (order_item) {
...
<template>
    <div class="bg-white">
        ...
        <div class="mx-auto px-12 py-8 bg-neutral-900">
            <h2 class="text-2xl font-bold tracking-tight text-white">Your Orders</h2>
            <p class="my-10">
            </p>
        </div>
        <div class="px-12 py-8 bg-neutral-900">
