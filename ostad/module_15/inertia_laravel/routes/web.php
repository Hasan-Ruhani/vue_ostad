...
use App\Http\Controllers\webPage\pageController;
use App\Http\Controllers\dashboardPage\dashboardController;
...
Route::get('/', function () {
    ...
    Route::get('/projects', [dashboardController::class, 'projects'])->name('projects')->middleware([AdminMiddleware::class]);
    Route::get('/create-project', [dashboardController::class, 'projectForms'])->name('projectForms')->middleware([AdminMiddleware::class]);
    Route::get('/forms', [dashboardController::class, 'forms'])->name('forms');

    Route::get('/login', [dashboardController::class, 'login'])->name('login');
    Route::get('/registratoin', [dashboardController::class, 'registratoin'])->name('registratoin');
